...
Plan:
1. Definir payload mínimo por evento sin PII.
2. Instrumentar selección de servicio/slot en booking.
3. Instrumentar checkout (inicio de pago, éxito y cancelación).
4. Instrumentar check-in/no-show desde calendario.
5. Asegurar clinicId/ids con datos de sesión o contexto.
6. Documentar decisión en DECISIONS/ADR.
...
- [x] No enviar PII (email/teléfono) en payload
- [x] Incluir clinicId derivado de sesión

UX Checks:
- [x] Eventos no bloquean UI
- [x] Sin impacto perceptible en performance
