...
Plan:
1. Definir matriz de permisos por rol para rutas y navegación.
2. Implementar guardrails en AppChrome/layout con estado “sin acceso”.
3. Añadir banner de redirección segura para roles sin permiso.
4. Gating de navegación y CTA “Nueva reserva” por rol.
5. Sincronizar rol/clinicId desde JWT en useAuth.
6. Añadir helper RBAC compartido para middleware y UI.
7. Actualizar ticket + documentación de decisiones.
...
- [x] Validación de rol por ruta
- [x] Guard para deep links
- [x] No exponer datos en UI al usuario sin rol
- [x] Consistencia con roles definidos en AI.md

UX Checks:
- [x] Mensaje “sin acceso” claro
- [x] CTA de retorno
