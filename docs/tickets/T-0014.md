...
## Plan
- [x] Migrar estilos inline a CSS Modules con tokens.
- [x] Reemplazar botones por `EventoraButton` y normalizar estados.
- [x] Añadir focus visible y aria-labels donde aplica.
- [x] Ajustar estados loading/error/empty y spacing a design system.
...
- Manual flow tested: Not run (pendiente validación visual booking + checkout).
- Capturas/logs (si aplica): No aplica.
...
## Riesgos / notas
- Decisión: usar CSS Modules con tokens y `EventoraButton` para coherencia Apple-like.
